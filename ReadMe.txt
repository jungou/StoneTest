================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Main_Test Project Overview
===============================================================================

The application wizard has created this Main_Test application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Main_Test application.
...
Main_Test.h
    ...
    project specific headers and declares the CMain_TestApp application class.
...
Main_TestDlg.h, Main_TestDlg.cpp - the dialog
    These files contain your CMain_TestDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Main_Test.pch and a precompiled types file named StdAfx.obj.
